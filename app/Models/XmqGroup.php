...
class XmqGroup extends Model
{
    protected $table = 'xmq_group';
    protected $fillable = ['group_id','group_name','group_url'];
    ...
    {
        return $this->hasMany('App\Models\XmqTopic','group_id', 'group_id');
    }
