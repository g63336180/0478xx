...
class XmqComment extends Model
{
    use MorphManyCommentsTrait,BelongsToUserTrait;
    protected $table = 'xmq_comment';
    protected $fillable = ['comment_id','created_at','owner', 'content','likes_count', 'topic_id'];
    ...
    public function question(){
        return $this->belongsTo('App\Models\XmqTopic');
    }
}
